...
//old
/*
#define solid_interactive_low								91
#define solid_interactive_high							160
...
#define solid_interactive_up_low						121
#define solid_interactive_up_high						140
...
#define non_solid high								89
#define solid_down_low								81
#define solid_down_high								90
#define solid_low											91
...
/*
//Old too
#define solid_interactive_low								104
#define solid_interactive_high							160
...
#define solid_interactive_up_low						113
#define solid_interactive_up_high						140
...
#define non_solid high								103
#define solid_down_low								95
#define solid_down_high								103
#define solid_low											104
...
enum Tiles {blank=0,pow_item_after=4,dark_gray=13,water_waves_surface=40,
			...
			blank_solid=177,wood_block = 180,dark_gray_solid=226,bounching_brick=228};

*/

enum Tiles {blank=0,pow_item_after=4,dark_gray=13,water_waves_surface=40,
			coin=53,flower_power=54,
			treasure_rand=55,treasure_star=56,treasure_whistle=57,treasure_hammer=58,treasure_pwing=59,treasure_cloud=63,treasure_anchor=64,
			flower_water=60,ladder=82,water_surface=83,water=84,
			brick=126,bonusbox_1_coin=134,bonusbox_8_coins=141,note=146,note_dark=147,falling_block=149,pow_item=153,bonusbox_after=160,
			blank_solid=176,wood_block = 179,dark_gray_solid=225,bounching_brick=227};
...
//	short Bg_width;
	short Bg_height;	
	short Border_left;//to "hide" secret areas beyond the rightmost part of the level.
	short Border_right;
	...
	unsigned char Event;	//describes which event to possibly occur when the level is completed
												//0: none
												//1: Card game
												//5: money ship
												//>50: Hidden mushrom house
	unsigned char Condition;//Describes under which conditions the event will occur
	unsigned char EX;//EX and EY gives the map position of the event
	unsigned char EY;
	//Special case: When ending level (End of a world): Event indicates which item mario wins when defeating boss.
	//							Condition != 0 : Ship Condition == 0 : Castle
...
typedef struct{
	...
	unsigned short Backgrounds[20];//holds the offset from start of file to start of the bg_struct

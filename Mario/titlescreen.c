...
//		Error = 3;
	...
	for(C=0;C<7;C++){
		...
		DrawSprite16SMASKR(screen_offset_sg_x+23+16*C,10,H,titlescreen_gfx+3*19*C,titlescreen_gfx+3*19*C+H,titlescreen_gfx+3*19*C+2*H);
		
	}
	
	for(C=0;C<4;C++){
				
		//GrayClipSprite16_SMASK_R(46+16*C,44,21,titlescreen_gfx +6*19*2+20*2+ 2*21*C,titlescreen_gfx +6*19*2+20*2+ +2*21*C+21,blank_sprite,GrayDBufGetHiddenPlane(LIGHT_PLANE),GrayDBufGetHiddenPlane(DARK_PLANE));
		//GrayClipSprite16_SMASK_R(screen_offset_sg_x+54+16*C,37,21,titlescreen_gfx +6*19*3+20*3+ 3*21*C,titlescreen_gfx +6*19*3+20*3+ +3*21*C+21,titlescreen_gfx +6*19*3+20*3+ +3*21*C+2*21,dBufHPL_G,dBufHPD_G);
		DrawSprite16SMASKR(screen_offset_sg_x+54+16*C,37,21,titlescreen_gfx +6*19*3+20*3+ 3*21*C,titlescreen_gfx +6*19*3+20*3+ +3*21*C+21,titlescreen_gfx +6*19*3+20*3+ +3*21*C+2*21);

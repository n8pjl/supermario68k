...
typedef struct{//Optimize! Skip some unnesseccarry variables, use macros in calculations instead!
	...
	unsigned short Nr_of_tilemasks;
	unsigned short Nr_of_fg_animations;
	unsigned short Nr_of_fg_mask_animations;
	unsigned short Nr_of_bg_tiles;
	unsigned short Nr_of_map_tiles;
	unsigned short Nr_of_map_animations;
...
/*
typedef struct{//Optimize! Skip some unnesseccarry variables, use macros in calculations instead!
	unsigned short Size_of_mariosprites;	//nr of shorts. this is valid for the next variables too...
	unsigned short Size_of_mariomasks;	
...
//	unsigned short Size_of_boss_masks;
	unsigned short Total_size;		//IN BYTES!!! (that means NOT short!) if size exseeds 64k (not likely) then use multiple files!
}spritefiledata;
*/

...
void GrayClipISprite16_RPLC_R(int16_t x, int16_t y, uint16_t height,
  ...
  for (r = first; r < last; r++) {
    put_row16((uint8_t *)dest0, x, (int16_t)(y + r), sprite[2 * r], 0xFFFF);
    put_row16((uint8_t *)dest1, x, (int16_t)(y + r), sprite[2 * r + 1], 0xFFFF);
  }
}
...
void GrayClipSprite16_SMASKBLIT_R(int16_t x, int16_t y, uint16_t height,
  ...
  for (r = first; r < last; r++) {
    ...
    put_row16((uint8_t *)dest0, x, (int16_t)(y + r), sprt0[r] & maskval, wr);
    put_row16((uint8_t *)dest1, x, (int16_t)(y + r), sprt1[r] & maskval, wr);
  }
}
